    ...
    <div class="relative flex items-center justify-between h-16">
      ...
      <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <a href="/" class="flex-shrink-0 flex items-center">
          <img class="block lg:hidden h-8 w-auto" src="\storage\img\logoArgospV2.png" alt="ARGOSP">
          <img class="hidden lg:block h-8 w-auto" src="\storage\img\logoArgospV2.png" alt="ARGOSP">
        </a>
      ...
      <!-- directiva de blade para verificar que el usuario se encuentra autentificado -->
      @auth
        ...
        <div class="ml-3 relative" x-data="{open: false}">
          <div>
            <button x-on:click="open = true" type="button" class="bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
              ...
              <!-- para mostrar la foto del usuario autentificado y recuperar su url -->
