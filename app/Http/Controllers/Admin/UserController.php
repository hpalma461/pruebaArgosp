...
class UserController extends Controller
{
    ...
    {
        //el metodo sync se encarga de ingresar los registro en la tabla intermedia llamada model_has_roles
        $user->roles()->sync($request->roles);

        //para redireccionar a la ruta edit y mandarle un mesaje de session con with
